...
def derive_js_recon_summary_fields(result: Any) -> dict[str, Any]:
    defaults: dict[str, Any] = {
        ...
        "js_recon_endpoint_candidates_total": 0,
        "js_recon_endpoint_candidates_unique": 0,
        "js_recon_endpoint_candidates_api_like": 0,
        "js_recon_endpoint_candidates_graphql_like": 0,
        "js_recon_endpoint_candidates_auth_like": 0,
        "js_recon_endpoint_candidates_login_like": 0,
        "js_recon_endpoint_candidates_admin_like": 0,
        "js_recon_endpoint_candidates_php_like": 0,
        "js_recon_endpoint_candidates_absolute": 0,
        "js_recon_endpoint_candidates_relative": 0,
        "js_recon_endpoint_candidates_internal_hint": 0,
        "js_recon_endpoint_candidates_external_hint": 0,
        "js_recon_endpoint_linkage_total": 0,
        "js_recon_endpoint_linkage_with_candidates": 0,
        "js_recon_endpoint_linkage_unique_sources": 0,
        "js_recon_endpoint_linkage_inline_sources": 0,
        "js_recon_endpoint_linkage_external_sources": 0,
        "js_recon_endpoint_linkage_internal_sources": 0,
        "js_recon_endpoint_linkage_multi_candidate_sources": 0,
        "js_recon_endpoint_linkage_api_sources": 0,
        "js_recon_endpoint_linkage_graphql_sources": 0,
        "js_recon_endpoint_linkage_auth_sources": 0,
        "js_recon_endpoint_linkage_login_sources": 0,
        "js_recon_endpoint_linkage_admin_sources": 0,
        "js_recon_endpoint_linkage_php_sources": 0,
        ...
        out.update(
            {
                ...
                "js_recon_endpoint_candidates_total": _to_int_count(summary.get("endpoint_candidates_total"), 0),
                "js_recon_endpoint_candidates_unique": _to_int_count(summary.get("endpoint_candidates_unique"), 0),
                "js_recon_endpoint_candidates_api_like": _to_int_count(summary.get("endpoint_candidates_api_like"), 0),
                "js_recon_endpoint_candidates_graphql_like": _to_int_count(summary.get("endpoint_candidates_graphql_like"), 0),
                "js_recon_endpoint_candidates_auth_like": _to_int_count(summary.get("endpoint_candidates_auth_like"), 0),
                "js_recon_endpoint_candidates_login_like": _to_int_count(summary.get("endpoint_candidates_login_like"), 0),
                "js_recon_endpoint_candidates_admin_like": _to_int_count(summary.get("endpoint_candidates_admin_like"), 0),
                "js_recon_endpoint_candidates_php_like": _to_int_count(summary.get("endpoint_candidates_php_like"), 0),
                "js_recon_endpoint_candidates_absolute": _to_int_count(summary.get("endpoint_candidates_absolute"), 0),
                "js_recon_endpoint_candidates_relative": _to_int_count(summary.get("endpoint_candidates_relative"), 0),
                "js_recon_endpoint_candidates_internal_hint": _to_int_count(summary.get("endpoint_candidates_internal_hint"), 0),
                "js_recon_endpoint_candidates_external_hint": _to_int_count(summary.get("endpoint_candidates_external_hint"), 0),
                "js_recon_endpoint_linkage_total": _to_int_count(summary.get("endpoint_linkage_total"), 0),
                "js_recon_endpoint_linkage_with_candidates": _to_int_count(summary.get("endpoint_linkage_with_candidates"), 0),
                "js_recon_endpoint_linkage_unique_sources": _to_int_count(summary.get("endpoint_linkage_unique_sources"), 0),
                "js_recon_endpoint_linkage_inline_sources": _to_int_count(summary.get("endpoint_linkage_inline_sources"), 0),
                "js_recon_endpoint_linkage_external_sources": _to_int_count(summary.get("endpoint_linkage_external_sources"), 0),
                "js_recon_endpoint_linkage_internal_sources": _to_int_count(summary.get("endpoint_linkage_internal_sources"), 0),
                "js_recon_endpoint_linkage_multi_candidate_sources": _to_int_count(summary.get("endpoint_linkage_multi_candidate_sources"), 0),
                "js_recon_endpoint_linkage_api_sources": _to_int_count(summary.get("endpoint_linkage_api_sources"), 0),
                "js_recon_endpoint_linkage_graphql_sources": _to_int_count(summary.get("endpoint_linkage_graphql_sources"), 0),
                "js_recon_endpoint_linkage_auth_sources": _to_int_count(summary.get("endpoint_linkage_auth_sources"), 0),
                "js_recon_endpoint_linkage_login_sources": _to_int_count(summary.get("endpoint_linkage_login_sources"), 0),
                "js_recon_endpoint_linkage_admin_sources": _to_int_count(summary.get("endpoint_linkage_admin_sources"), 0),
                "js_recon_endpoint_linkage_php_sources": _to_int_count(summary.get("endpoint_linkage_php_sources"), 0),
                "js_recon_endpoint_linkage_route_sources": _to_int_count(summary.get("endpoint_linkage_route_sources"), 0),
                "js_recon_endpoint_linkage_max_candidates_per_source": _to_int_count(summary.get("endpoint_linkage_max_candidates_per_source"), 0),
                "js_recon_endpoint_linkage_avg_candidates_per_source": float(summary.get("endpoint_linkage_avg_candidates_per_source") or 0.0),
            }
        )
