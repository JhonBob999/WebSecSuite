...
class Ui_scraper_panel(object):
    def setupUi(self, scraper_panel):
        ...
        self.logOutput.setGeometry(QRect(880, 115, 781, 411))
        self.logOutput.setReadOnly(True)
        self.lbl_logs = QLabel(scraper_panel)
        self.lbl_logs.setObjectName(u"lbl_logs")
        self.lbl_logs.setGeometry(QRect(1620, 110, 51, 31))
        font = QFont()
        ...
        self.taskTable.setGeometry(QRect(10, 80, 861, 791))
    ...
    def retranslateUi(self, scraper_panel):
        ...
        self.btnFindNext.setText(QCoreApplication.translate("scraper_panel", u"Next", None))
