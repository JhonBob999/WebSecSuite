...
class ScraperTabController(QWidget):
    def __init__(self, parent=None):
        ...
        # ---- SessionController: сохранение/загрузка сессии ----
        self.session_ctl = SessionController(
            parent=self,
            table_ctl=self.table_ctl,
            task_manager=self.task_manager,
            log_panel=self.log,
        )
        self.btnSaveSession.clicked.connect(self.session_ctl.on_save_clicked)
        self.btnLoadSession.clicked.connect(self.session_ctl.on_load_clicked)
